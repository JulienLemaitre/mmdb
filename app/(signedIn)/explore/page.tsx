    ...
    <main className="p-8">
      {
        // Persons
        persons.map((person) => {
          // if (person.lastName.includes("eethoven")) {
          //   console.log("person :", person);
          //   // console.log(`[] pieceVersion :`, pieceVersion);
          //   // console.log(`[] pieceSource :`, pieceSource);
          // }
          return (
            <div key={person.id} className="my-16">
              <h1 className="text-3xl font-bold">{`${person.firstName} ${person.lastName}`}</h1>
              {
                ...
                person.compositions.map((piece) => {
                  ...
                  if (piece.title.includes("Fugue in D Major, Op. 137")) {
                    // if (person.lastName.includes("eethoven")) {
                    // console.log("person :", person);
                    // console.log(
                    //   `[] JSON pieceVersion`,
                    //   JSON.stringify(pieceVersion, null, 2),
                    // );
                    // console.log(`[] pieceVersion :`, pieceVersion);
                    console.log(`[] pieceSource :`, pieceSource);
                  }
                              ...
                              <div className="flex">
                                ...
                                <div>
                                  ...
                                  {pieceSource.mMSource.references &&
                                    pieceSource.mMSource.references.length >
                                      0 && (
                                      <div className="text-gray-700">
                                        {JSON.stringify(
                                          pieceSource.mMSource.references,
