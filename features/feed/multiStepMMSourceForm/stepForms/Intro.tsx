  ...
  if (session.mode === "review") {
    return (
      <div className="w-full prose prose-a:text-primary prose-a:hover:text-primary/70">
        ...
        <p>
          You are reviewing a submitted MM Source. Inspect and adjust any fields
          across the steps. Your modifications are kept in a local draft until
          final submission.
        </p>
        <p>
          ...
          button at the top right of this page. You will find contextual help
          for each step and a general glossary of the terminology used on this
          website.
        </p>
